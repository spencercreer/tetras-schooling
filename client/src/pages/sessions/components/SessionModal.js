...
const SessionModal = ({ visible, handleCloseModal, sessionId }) => {
    ...
    const onFinish = async ({ prework, b2b, clock_out, show, topics, effort, notes }) => {
